...
| [Plugin Inventory and Activation Scope](active/plugin-inventory-activation-scope/README.md) | Active | #1507 |
...
| [agent-bridge Delegated Result Snapshots](active/agent-bridge-delegated-result-snapshots/README.md) | Draft | #1452 |
