...
- The lineage surfaces landed through #1710 and #1706 was closed. Opened #1712
  for the final rollout/hardening slice: platform containment and atomicity,
  mixed-version behavior, large-history latency, cross-scenario convergence,
  remaining validation closure, and effort archival.
