...
| [`progressive-context-disclosure-baseline`](scenarios/progressive-context-disclosure-baseline/) | P | **Frozen progressive-disclosure baseline:** inventories every suite-owned context contributor, validates the representative synthetic owner/task corpus and contained guide locators, records deterministic full-inline and concise-kernel counts, and rejects content-bearing evidence before any Tier-E deferral, reference, emphasis, or assembly comparison runs. |
