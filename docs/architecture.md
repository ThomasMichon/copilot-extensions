...
| [agent-pull-requests](../plugins/agent-pull-requests/) | Cross-repo PR CLI | — | `~/.local/bin/agent-pull-requests` | On-demand CLI; current scaffold shells through `agent-worktrees repos gh <owner/repo> -- ...` for GitHub account/token resolution and does not require a local checkout |
