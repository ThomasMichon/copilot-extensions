...
$_runtimeRoot = Join-Path $env:USERPROFILE '.agent-mcp'
...
if (Test-Path "env:AGENT_MCP_NO_SELFPROVISION") {
    [Console]::Error.WriteLine("[$_command] runtime not provisioned (AGENT_MCP_NO_SELFPROVISION set).")
    exit 1
}
