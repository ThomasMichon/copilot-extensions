#!/usr/bin/env python3
"""Write agent-mcp guidance as a sessionStart side effect.
...
_GUIDANCE_HEADER = "# Agent MCP session guidance\n\n"
...
def write_session_guidance(payload: dict, *, home: Path | None = None) -> bool:
    ...
    try:
        ...
        if _is_link_or_reparse(instructions_dir):
            return False
        target_dir = instructions_dir / "agent-mcp"
