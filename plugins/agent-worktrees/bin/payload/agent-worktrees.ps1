...
$env:PYTHONUTF8 = '1'
$_plugin = 'agent-worktrees'
$_command = 'agent-worktrees'
$_payloadRoot = (Resolve-Path (Join-Path $PSScriptRoot '..\..')).Path
$_runtimeRoot = Join-Path $env:USERPROFILE '.agent-worktrees'
$_bootTraceLogPath = Join-Path $_runtimeRoot 'logs\activity.jsonl'
