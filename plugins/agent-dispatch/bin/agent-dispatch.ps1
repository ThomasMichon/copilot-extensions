...
if (Test-Path "env:AGENT_DISPATCH_NO_SELFPROVISION") {
    [Console]::Error.WriteLine("[$_command] runtime not provisioned (AGENT_DISPATCH_NO_SELFPROVISION set).")
    exit 1
}
