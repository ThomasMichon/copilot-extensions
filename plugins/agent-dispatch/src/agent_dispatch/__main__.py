...
# Re-exported for backward compatibility: the schedule/emitter/webhook/
# reservations producer-family CLI commands live in producers_cli.py now
# (see that module's docstring), but build_parser's set_defaults() and tests
# below still reference them by their agent_dispatch.__main__ attribute path.
