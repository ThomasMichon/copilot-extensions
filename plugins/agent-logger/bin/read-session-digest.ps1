...
$_module = 'agent_logger.segmenter.read_digest'
...
if (Test-Path "env:AGENT_LOGGER_NO_SELFPROVISION") {
    [Console]::Error.WriteLine("[$_command] runtime not provisioned (AGENT_LOGGER_NO_SELFPROVISION set).")
    exit 1
}
