...
$_runtimeRoot = Join-Path $env:USERPROFILE '.agent-ssh'
...
if (Test-Path "env:AGENT_SSH_NO_SELFPROVISION") {
    [Console]::Error.WriteLine("[$_command] runtime not provisioned (AGENT_SSH_NO_SELFPROVISION set).")
    exit 1
}
