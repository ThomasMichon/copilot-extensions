...
$_runtimeRoot = Join-Path $env:USERPROFILE '.agent-codespaces'
...
if (Test-Path "env:AGENT_CODESPACES_NO_SELFPROVISION") {
    [Console]::Error.WriteLine("[$_command] runtime not provisioned (AGENT_CODESPACES_NO_SELFPROVISION set).")
    exit 1
}
