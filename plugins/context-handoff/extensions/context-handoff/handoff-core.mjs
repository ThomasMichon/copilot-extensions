...
export function markSessionStateHandoffConsumed(
  ...
  { consumedBySession = null, handoffId = null, metadata = null } = {},
) {
...
export function storeHandoff({ promptText, sid, cwd, title, preferTask = true, nativeGoalCheckpoint = null, nativeGoalState = null }) {
