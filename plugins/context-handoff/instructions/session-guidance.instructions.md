...
`instructions/context-handoff/session-guidance.instructions.md` inside that
folder if it exists, and treat its process-manager-agnostic continuity guidance
