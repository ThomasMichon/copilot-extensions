...
class WarningTracker:
    ...
    _entries: set[tuple[str, str]] = field(default_factory=set, init=False, repr=False)
    ...
    def select(
        ...
        *,
        ...
        current_entries = {(finding.registry, finding.entry) for finding in ordered}
        recovered = len(self._entries - current_entries)
