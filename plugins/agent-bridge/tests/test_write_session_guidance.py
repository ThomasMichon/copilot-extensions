"""Tests for the agent-bridge session guidance writer."""
...
_SPEC = importlib.util.spec_from_file_location("agent_bridge_guidance_writer_under_test", _SCRIPT)
...
def test_powershell_wrapper_writes_bounded_session_file(tmp_path):
    ...
    assert content.startswith("# Agent Bridge session guidance\n\n")
