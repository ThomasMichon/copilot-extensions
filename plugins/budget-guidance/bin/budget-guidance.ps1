...
if (Test-Path "env:BUDGET_GUIDANCE_NO_SELFPROVISION") {
    [Console]::Error.WriteLine("[$_command] runtime not provisioned (BUDGET_GUIDANCE_NO_SELFPROVISION set).")
    exit 1
}
