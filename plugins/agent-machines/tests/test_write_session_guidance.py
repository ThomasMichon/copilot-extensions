"""Tests for the agent-machines session guidance writer."""
...
_SPEC = importlib.util.spec_from_file_location("agent_machines_guidance_writer_under_test", _SCRIPT)
...
def test_powershell_wrapper_writes_bounded_session_file(tmp_path):
    ...
    assert content.startswith("# Agent Machines session guidance\n\n")
...
def test_hook_and_projection_contracts():
    ...
    assert "instructions/agent-machines/session-guidance.instructions.md" in pointer
