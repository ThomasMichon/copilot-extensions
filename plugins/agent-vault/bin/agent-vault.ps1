...
$_runtimeRoot = Join-Path $env:USERPROFILE '.agent-vault'
...
if (Test-Path "env:AGENT_VAULT_NO_SELFPROVISION") {
    [Console]::Error.WriteLine("[$_command] runtime not provisioned (AGENT_VAULT_NO_SELFPROVISION set).")
    exit 1
}
